...
EXPORT_FUNC void pushMergedPresynapticUpdateGroup1ToDevice(unsigned int idx, uint8_t* d, float* denDelay, uint32_t* denDelayPtr, float* g, uint32_t* ind, uint32_t* rowLength, uint32_t* srcSpk, uint32_t* srcSpkCnt);
