...
void pushMergedNeuronUpdateGroup0ToDevice(unsigned int idx, float* Iinh, float* RefracTime, float* V, float* outPostInSyn0, uint32_t* spkCntSynSpike0, uint32_t* spkSynSpike0) {
